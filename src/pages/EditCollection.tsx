...
export default function EditCollection() {
    ...
    const fetchCollectionData = async () => {
      ...
      try {
        ...
        if (result.translations && result.translations.length > 0) {
          setTranslations(result.translations.map((t: any) => ({
  ...
  const handleAddTranslation = async () => {
    ...
    try {
      // Update the translation on the server
      await collectionService.updateCollectionTranslation(collectionId, {
        lang_code: currentTranslation.lang_code,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await collectionService.updateCollection(collectionId, collectionData);
